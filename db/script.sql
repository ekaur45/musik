CREATE DATABASE  IF NOT EXISTS `musik` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `musik`;
...
CREATE TABLE `user_music` (
  ...
  `picLocation` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`)
